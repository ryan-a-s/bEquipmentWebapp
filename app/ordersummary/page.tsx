...
import { getLocationLabel, sites } from '../../context/locations';
import { equipmentList } from '../../context/equipment';

export default function ReviewPage() {
  const { location, secondaryLocation, dependencyStatus, patientWeight, equipment } = useAppContext();
